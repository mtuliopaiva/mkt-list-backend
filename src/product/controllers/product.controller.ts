...
export class ProductController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The product has been sucessfully updated.',
    type: ReadProductDto,
  })
  @ApiQuery({ name: 'uuid', type: String, required: true })
  ...
  async restoreProduct(
    ...
    return await this.commandBus.execute(new RestoreProductCommand(uuid));
  }
  ...
  async softDeleteProduct(
    ...
    return await this.commandBus.execute(new DeleteProductCommand(uuid));
  }
}
